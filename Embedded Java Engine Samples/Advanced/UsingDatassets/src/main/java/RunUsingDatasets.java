    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            try {
                ...
                throw new ClassNotFoundException("Please add the SqlServer JDBC connector to your classpath. Details can be found in the README", e);
            }
            ...
            // apply the SQL data
            DataSourceProvider dsJdbc = new JdbcDataSource(
                    "com.microsoft.sqlserver.jdbc.SQLServerDriver",
                    "jdbc:sqlserver://mssql.windward.net;DatabaseName=Northwind;encrypt=true;trustServerCertificate=true",
                    "demo",
                    "demo"
            );
