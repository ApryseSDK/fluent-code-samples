...
public class FluentCustomFunctions {
    ...
    static
    {
        ...
        functionName[2] = "CUSTOMFUNCTION";
        functionFullName[2] = "CUSTOMFUNCTION()";
        functionDescription[2] = "Returns a custom string denoting our custom function";
        functionNumberOfArgument[2] = new Integer(0);
        functionArgumentName[2] =  null;
        functionArgumentDescription[2] =  null;
        functionArgumentType[2] = null;
    ...
    {
        return new String("My Custom Function works!");
    }
