...
/**
 * A sample usage of Fluent. This program generates reports based on the command line.
 ...
 * <p/>
 * To get the parameters, the GenerateAnyDocumentCommandLine with no parameters and it will list them all out.
 */

public class GenerateAnyDocumentCommandLine {

    private static Logger log = LogManager.getLogger(GenerateAnyDocumentCommandLine.class);

    /**
     * Create a report using Fluent.
     *
    ...
    public static void main(String[] args) throws Throwable {
        ...
        // parse the arguments passed in. This method makes no calls to Fluent, it merely organizes the passed in arguments.
        ...
        try {
            ...
            if (!cmdLine.isPerformance()) {
                ...
                new GenerateAnyDocumentCommandLine().runMultipleReports(cmdLine);
            }
...
//        report.setModeProcessEmbedded(ProcessReport.MODE_PROCESS_EMBEDDED_COPY);
    ...
    private static void DisplayUsage() {
        System.out.println("Fluent version " + ProcessReport.getVersion());
        System.out.println("usage: GenerateAnyDocumentCommandLine template_file output_file [-basedir path] [-xml xml_file | -sql connection_string | -oracle connection_string | -ole oledb_connection_string] [licenseKey=value | ...]");
    ...
    /**
     * This class contains everything passed in the command line. It makes no calls to Fluent.
     */
