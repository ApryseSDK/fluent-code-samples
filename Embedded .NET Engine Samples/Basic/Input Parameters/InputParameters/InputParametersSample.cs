...
namespace InputParameters
{
    class InputParametersSample
    {
        static void Main(string[] args)
        {
            ...
            //This is where we pass in the input parameters
			Dictionary<string, object> map = new Dictionary<string, object>();
            //order is our variable
            map.Add("order", 10537);
            //This is the function where we actually tell our report the input parameter values
