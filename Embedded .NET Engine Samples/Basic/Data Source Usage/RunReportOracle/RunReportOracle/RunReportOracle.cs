...
namespace RunReportOracle
{
    class RunReportOracle
    {
        static void Main(string[] args)
        {
            ...
            // Oracle data source
            string strConn = "Data Source=oracle.windward.net/XE;Persist Security Info=True;User ID=hr;Password=hr;";
			// you can also use the "Oracle.ManagedDataAccess.Client" connector if installed (.NET 4.0 or later only)
            IReportDataSource data = new AdoDataSourceImpl("Oracle.ManagedDataAccess.Client", strConn);
